...
input_filename = 'propagation_constante//c//input.in'  # Name of the input file
nsteps=5000
# nx=78
...
# Simulations
output_file = f"propagation_constante/c/{paramstr}={param}.out"
...
image.save(f"propagation_constante/c/{paramstr}={param}.gif", writer='imagemagick')
plt.show()